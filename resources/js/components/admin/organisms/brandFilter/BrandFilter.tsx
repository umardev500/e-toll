...
export const BrandFilter: React.FC<Props> = ({ setState }) => {
    ...
    const handleStatus = (value: BrandStatus) => {
        setStatus(value)
    }
                    ...
                    <div className="mt-8">
                        ...
                        <div className="inline-flex items-center mr-5 mb-3">
                            <input
                                ...
                                name="status"
                            />
                            <span className="text-gray-400 font-medium roboto leading-none ml-2">Online</span>
                        </div>
                        <div className="inline-flex items-center mr-5 mb-3">
                            <input
                                onChange={() => {
                                ...
                                name="status"
                            />
                            <span className="text-gray-400 font-medium roboto leading-none ml-2">Deleted</span>
                        </div>
                    </div>
                </div>
