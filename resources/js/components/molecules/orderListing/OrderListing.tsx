    ...
    return (
        <div className="flex-1 p-5 border border-gray-100 rounded-lg shadow-[0_3px_5px_rgba(0,0,0,.05)]">
            ...
            <div className="flex flex-wrap justify-between">
                ...
                <div className="roboto whitespace-nowrap">
            ...
            <div className="mt-8 border-gray-100">
                <div className="flex flex-wrap items-center justify-between gap-2.5">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button className="whitespace-nowrap outline-none text-sm font-medium roboto border border-teal-600 bg-teal-600 hover:bg-teal-700 text-white px-4 py-1.5 rounded">
                            See more
                        </button>
                    </div>
                </div>
